...
async function processarAceite(sock, db, telefone, motorista, cargaId, sessionRef) {
  ...
  await enviarTexto(sock, telefone,
    ...
    `🔑 Chave Pix: *${pixKey}*\n\n` +
    (carga.linkReferencia ? `📋 *Informações completas da carga:*\n${carga.linkReferencia}\n\nAcesse o link acima para ver todas as regras, bônus e exigências desta carga.\n\n` : '') +
    `Por favor, envie o comprovante de pagamento aqui neste WhatsApp.`
  );
